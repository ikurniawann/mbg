    ...
    <div className="p-6">
      ...
      <header className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Selasa, 17 April 2026 • Pantau lokasi distribusi makanan</p>
        </div>
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-0.5">Petugas: {r.petugas}</p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <p className={`text-xl font-bold ${r.waktuTiba ? 'text-slate-800' : 'text-slate-400'}`}>
                  {r.waktuTiba || '—'}
                </p>
              </div>
            </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        ...
        <div className="bg-gray-100 rounded-xl h-64 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-sm text-slate-500 mt-2">Peta tracking lokasi distribusi</p>
            <p className="text-xs text-slate-400">Integrasi Google Maps / Maps API</p>
          </div>
        </div>
      </div>
    </div>
